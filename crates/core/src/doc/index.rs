...
impl<'a> IndexOperation<'a> {
	...
	#[allow(clippy::needless_lifetimes)] // Explicit lifetime needed for struct coherence
	fn get_unique_index_key(&self, v: &'a StoreKeyArray) -> Result<key::index::Index<'a>> {
	...
	#[allow(clippy::needless_lifetimes)] // Explicit lifetime needed for struct coherence
	fn get_non_unique_index_key(&self, v: &'a StoreKeyArray) -> Result<key::index::Index<'a>> {
